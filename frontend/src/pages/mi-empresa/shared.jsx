...
export const buildConfigPayload = (config) => ({
  tema: config.tema,
...
export function MiEmpresaModuleShell({
  eyebrow,
  title,
  description,
  actions,
    ...
    <div className="space-y-6">
      ...
      >
        <div className="grid gap-3 md:grid-cols-2">
            ...
            className={({ isActive }) =>
              `rounded-2xl border p-4 transition ${
                isActive
                  ...
                  : 'border-app bg-white/70 hover:bg-[var(--panel-soft)]'
              }`
            }
          >
            <div className="eyebrow">Modulo 01</div>
            <div className="mt-2 text-base font-semibold text-main">
              Informacion de empresa
            </div>
            <p className="mt-2 text-[12px] leading-6 text-soft">
              Datos fiscales, logo, contacto y edicion de identidad comercial.
            </p>
          </NavLink>
          <NavLink
            to="/mi-empresa/configuracion"
            className={({ isActive }) =>
              `rounded-2xl border p-4 transition ${
                isActive
                  ? 'border-[var(--accent-line)] bg-[var(--accent-soft)]'
          ...
          >
            <div className="eyebrow">Modulo 02</div>
            <div className="mt-2 text-base font-semibold text-main">
              Configuracion operativa
            </div>
            <p className="mt-2 text-[12px] leading-6 text-soft">
              Apariencia, stock negativo, atajos POS y preferencias de tirilla.
            </p>
          </NavLink>
        </div>
      </SectionShell>
...
export function MiEmpresaUnavailable() {
  return (
    <SectionShell
...
export function ShortcutField({ label, helper, value, disabled, onChange }) {
  return (
...
export function EmpresaModuleToasts({ toasts, closeToast }) {
